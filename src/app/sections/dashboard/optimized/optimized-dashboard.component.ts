...
@Component({
  ...
  standalone: true,
  imports: [MetricsGridComponent, FilterBarComponent, SkeletonComponent, ChartsComponent, DecimalPipe, ScrollingModule],
  template: `
    @if (store.isLoading()) {
      <div class="loading">
      ...
      @defer (on viewport) {
        ...
        <div class="charts-skeleton">
          <div class="chart-card"><app-skeleton height="12rem" /></div>
          <div class="chart-card"><app-skeleton height="12rem" /></div>
          <div class="chart-card"><app-skeleton height="12rem" /></div>
          <div class="chart-card"><app-skeleton height="12rem" /></div>
        </div>
      ...
      <div class="table-container">
        <div class="table-info">
          <span class="virtual-badge">Virtualized list ({{ visibleCount }} visible of {{ store.filteredTransactions().length | number }})</span>
        </div>
